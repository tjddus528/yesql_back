...
public enum BaseResponseStatus {
    ...
    REGISTER_SUCCESS(true, 1001, "now you're user :)"),
     ...
     */
    // 계정관련(2000~)
    LOGIN_INCORRECT(false, 2000,"아이디 혹은 비밀번호를 다시 확인해주세요."),
    NO_DATABASE(false, 2001, "유저의 데이터베이스가 존재하지 않습니다. welcome으로 이동해 데이터베이스를 생성해주세요."),
